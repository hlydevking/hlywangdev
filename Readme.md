...
<svg xmlns="http://www.w3.org/2000/svg" width="495" height="195" viewBox="0 0 495 195" fill="none">
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 124.29775014434182;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      <text x="0" y="0" class="header" data-testid="header">hlywangdev's GitHub Stats</text>
    </g>
      </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat" x="190" y="12.5" data-testid="stars">14</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat" x="190" y="12.5" data-testid="commits">374</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat" x="190" y="12.5" data-testid="prs">13</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat" x="190" y="12.5" data-testid="contribs">21</text>
    </g>
  </g>
    </svg> 
